...
class _RegistrationStep2State extends State<RegistrationStep2>
  ...
  static const Color labelTextColor = Color(0xFFF8F8F8);
                                              ...
                                              child: DropdownButton2<String>(
                                                ...
                                                dropdownStyleData: DropdownStyleData(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    ...
                                                    borderRadius: BorderRadius.circular(15),
                                                    border: Border.all(
                                                      color: _isCollegeEmpty ? const Color(0xFFED6C6A) : const Color(0xFFD9D9D9), 
                                                      width: _isCollegeEmpty ? 1.5 : 1.0, 
                                                    ),
                                                  ),
                                                  offset: const Offset(0, -4), // starts below the college box field
                                                ),
                                                ...
                                                iconStyleData: const IconStyleData(
                                                  icon: Padding(
                                                    ...
                                                    child: Icon (Icons.arrow_drop_down, color: Color (0xFF747474)),
                                                  ),
